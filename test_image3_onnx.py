...
onnx_transformer_encoder = onnxruntime.InferenceSession("TransformerEncoder.onnx")
onnx_transformer_decoder = onnxruntime.InferenceSession("TransformerDecoder.onnx")
...
def eval(ds, org_img, cut_off = 0.5, locations0 = None, glyphfeatures0 = None):
    ...
    for n, inputs in enumerate(ds):
        ...
        heatmap, features = onnx_detector.run(['heatmap','feature'], {'image': images.astype(np.float32)})
