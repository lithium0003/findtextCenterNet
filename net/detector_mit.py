...
from .mix_transformer import mit_b0, mit_b1, mit_b2, mit_b3, mit_b4, mit_b5, load_pretrain
    ...
    def build(self, input_shape):
        ...
        if self.pre_weight:
            ...
            path_to_downloaded_file = tf.keras.utils.get_file(
                origin='https://bucket.lithium03.info/mit_preweights/%s.pickle'%self.backbone.name)
