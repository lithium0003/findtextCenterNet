...
class Encoder(nn.Module):
    def __init__(self, input_dim, embed_dim, head_num, max_seq_len=5000, block_num = 6, dropout = 0.05):
        super().__init__()
        self.dim = embed_dim
...
class Decoder(nn.Module):
    def __init__(self, embed_dim, head_num, max_seq_len=5000, block_num = 6, dropout = 0.05):
        super().__init__()
        self.head_num = head_num
