...
def transform_crop(image, textline, sepline, position, codelist):
    im_h,im_w = image.shape
    im_h2,im_w2 = textline.shape
    
    fiximage = inverse_partial(image)
...
def random_background(im, bgimg):
